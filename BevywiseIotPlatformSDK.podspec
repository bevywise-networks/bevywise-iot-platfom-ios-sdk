...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/support@bevywise.com/BevywiseIotPlatformSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'support@bevywise.com' => 'support@bevywise.com' }
  s.source           = { :git => 'https://github.com/support@bevywise.com/BevywiseIotPlatformSDK.git', :tag => s.version.to_s }
